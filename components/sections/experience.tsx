    ...
    return (
        ...
        >
             ...
             <div className="flex-1 bg-[#0d0d0d] border border-zinc-800 rounded-xl p-6 md:p-8 hover:border-zinc-700 transition-colors relative">
                 ...
                 <div className="flex flex-wrap gap-4 text-xs text-zinc-500 font-mono mb-6 md:hidden">
                     <span>{location}</span>
                     <span>{period}</span>
                 </div>
                 <div className="hidden md:flex gap-4 text-xs text-zinc-500 font-mono mb-6">
